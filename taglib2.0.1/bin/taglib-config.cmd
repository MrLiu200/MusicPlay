...
:doit
if /i "%1#" == "--libs#"    echo -LC:/software/taglib/taglib2.0.1/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IC:/software/taglib/taglib2.0.1/include -IC:/software/taglib/taglib2.0.1/include/taglib
if /i "%1#" == "--version#" echo 2.0.1
if /i "%1#" == "--prefix#"  echo C:/software/taglib/taglib2.0.1
